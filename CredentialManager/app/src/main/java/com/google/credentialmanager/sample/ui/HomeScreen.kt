    ...
    Column(
        ...
        Column(modifier = Modifier
            ...
            ShrineButton(
                ...
                androidx.compose.material3.Text(text = stringResource(id = R.string.sign_in))
            }
            ...
            ShrineButton(
                ...
                androidx.compose.material3.Text(text = "Proceed without Signing In")
            }
